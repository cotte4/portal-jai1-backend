/**
 * Consent Form Template - ACUERDO POR PRESTACION DE SERVICIOS
 * All text content for the consent form document
 */

export const CONSENT_FORM_TITLE = 'ACUERDO POR PRESTACION DE SERVICIOS';

export const CONSENT_FORM_INTRO = `Entre JAI-1, con domicilio electronico en la casilla de correo jai1@memas.agency, en adelante la empresa, y`;

export const CONSENT_FORM_INTRO_PART2 = `, DNI/Pasaporte`;

export const CONSENT_FORM_INTRO_PART3 = `, con domicilio en calle`;

export const CONSENT_FORM_INTRO_PART4 = `de la ciudad de`;

export const CONSENT_FORM_INTRO_PART5 = `y electronico en la casilla de correo`;

export const CONSENT_FORM_INTRO_PART6 = `, en adelante el cliente, se celebra el presente acuerdo sujeto a las siguientes clausulas y condiciones:`;

export const CONSENT_FORM_CLAUSES = [
...
export const CONSENT_FORM_CLOSING = `En prueba de conformidad, se firman dos ejemplares de un mismo tenor y a un solo efecto,`;

export const CONSENT_FORM_SIGNATURE_LABELS = {
  date: 'a los',
  month: 'del mes de',
  year: 'de',
  clientSignature: 'FIRMA CLIENTE:',
  jai1Signature: 'FIRMA JAI-1:',
};
